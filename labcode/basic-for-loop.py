...
print("Use of range with start / stop specified")
...
print("Use of range with increment specified")
...
print("Increment can be used for a loop that counts backwards")
...
print("First approach to printing all odd numbers between 1 and 10")

for i in range (1, 11, 2):
    print (i)

print("Second approach to printing all odd numbers between 1 and 10")
...
print ("The range function is implemented ")
print ("to prevent infinite loop due to incorrect increments")
# A potential loop situation below
