...
print ("Loop to obtain numbers from user")
print ("Sums these numbers")
print ("Continue until the user ")
...
print ("While loops can result in infinite loops if you are not careful")
